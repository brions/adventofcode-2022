...
# given a list of parts to execute and the mapping of those part names to functions,
# run each part in turn provided the list input lines
...
def readLines(inputFile: str) -> list:
    ...
    fh = open(inputFile, 'r')
    return list(map(lambda l: l.rstrip(), fh.readlines()))
